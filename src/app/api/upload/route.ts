...
export async function POST(req: NextRequest) {
  try {
    ...
    const track = await Track.create({
      ...
      coverUrl: coverImage ? `https://gateway.pinata.cloud/ipfs/${coverHash}` : 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=600',
      audioFile: audioUpload.IpfsHash,
      audioUrl: `https://gateway.pinata.cloud/ipfs/${audioUpload.IpfsHash}`,
      ipfsHash: audioUpload.IpfsHash,
