...
import { Play, Pause, Heart, MoreHorizontal, Plus, DollarSign } from 'lucide-react';
      ...
      <div className="mt-2 flex items-center justify-between text-xs text-[#b3b3b3]">
        ...
        <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            ...
            className="p-2 rounded-full bg-black/60 backdrop-blur-sm text-white hover:text-[#1DB954]"
            title="Tip artist"
          >
